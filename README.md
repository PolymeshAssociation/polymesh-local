...
polymesh-local/2.0.2 linux-x64 node-v14.18.0
...
_See code: [src/commands/clean.ts](https://github.com/PolymathNetwork/polymesh-local/blob/v2.0.2/src/commands/clean.ts)_
...
_See code: [src/commands/info.ts](https://github.com/PolymathNetwork/polymesh-local/blob/v2.0.2/src/commands/info.ts)_
...
_See code: [src/commands/load.ts](https://github.com/PolymathNetwork/polymesh-local/blob/v2.0.2/src/commands/load.ts)_
...
_See code: [src/commands/ls.ts](https://github.com/PolymathNetwork/polymesh-local/blob/v2.0.2/src/commands/ls.ts)_
...
_See code: [src/commands/rm.ts](https://github.com/PolymathNetwork/polymesh-local/blob/v2.0.2/src/commands/rm.ts)_
...
_See code: [src/commands/save.ts](https://github.com/PolymathNetwork/polymesh-local/blob/v2.0.2/src/commands/save.ts)_
...
_See code: [src/commands/start.ts](https://github.com/PolymathNetwork/polymesh-local/blob/v2.0.2/src/commands/start.ts)_
...
_See code: [src/commands/stop.ts](https://github.com/PolymathNetwork/polymesh-local/blob/v2.0.2/src/commands/stop.ts)_
<!-- commandsstop -->
